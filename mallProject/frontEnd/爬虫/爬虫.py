...
def get_url():
    ...
    for i in range(2,3517):
        url=f'https://www.1688mk.com/move/7/index_{i}.html'
        ...
        for i in urllist:
            ...
            movepath=host+i[0]
            print(name,movepath)
            with open('链接.txt','a',encoding='utf-8') as f:
                f.write(f'{name}:{movepath}\n')

def de():
    with open('链接.txt','r',encoding='utf-8') as f:
        for i in f.readlines():
            ...
            with open('视频链接.txt','a',encoding='utf-8') as f:
                f.write(f'{deurl}\n')
